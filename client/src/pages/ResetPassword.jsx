  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/reset-password', {
        ...
        body: JSON.stringify({
          email: form.email,
          token: form.token,                       // ✅ tên field: token
          new_password: form.new_password,         // ✅ new_password
          new_password_confirmation: form.new_password_confirmation, // ✅ _confirmation
        }),
      })
            ...
            <input
              ...
              onChange={(e) =>
                handleChange({
                  target: {
                    name: 'token',
                    value: e.target.value.replace(/\D/g, ''), // chỉ cho số
                  },
                })
              }
              placeholder="Mã OTP được gửi qua email"
            />
          </label>
