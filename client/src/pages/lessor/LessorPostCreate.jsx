  ...
  export default function LessorPostCreate() {
    ...
    const [environmentFeatures, setEnvironmentFeatures] = useState([])
  ...
  useEffect(() => {
    async function loadInitial() {
      try {
        ...
        setEnvironmentFeatures(envJson.data || envJson || [])
  ...
  selectedEnvironment.forEach((id, index) => {
      ...
      <section className="lessor-page">
        ...
        <div className="lessor-section--card">
          ...
          <form className="lessor-form" onSubmit={handleSubmit}>
            ...
            <div className="lessor-form__row">
              <div className="lessor-form__col">
                <h3 className="lessor-subtitle">Môi trường xung quanh</h3>

                <div className="lessor-chip-list">
                  {environmentFeatures.map(e => (
                    <label key={e.id} className="lessor-chip-input">
                      <input
                        type="checkbox"
                        checked={selectedEnvironment.includes(e.id)}
                  ...
                  {environmentFeatures.length === 0 && (
                    <p className="lessor-note">Chưa có dữ liệu môi trường.</p>
                  )}
                </div>
              </div>
            </div>
